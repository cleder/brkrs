...
| Index | Image | Name | Score | Description |
|-------|-------|------|-------|-------------|
| 50 ✅️ | ![Level Up](img/bricks/Stonelevelup.gif) | Smiley/Level Up | 0 | Advances to next level |
| 54 ✅️ | ![Level Down](img/bricks/Stoneleveldown.gif) | Level Down | 0 | Returns to previous level |
